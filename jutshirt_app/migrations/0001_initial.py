    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_dept', models.CharField(blank=True, max_length=100)),
                ('customer_year', models.CharField(blank=True, max_length=100)),
                ('customer_phone', models.CharField(blank=True, max_length=100)),
                ('customer_faculty', models.CharField(blank=True, max_length=100)),
                ('profile_pic', models.FileField(default='/media/user.png', upload_to='')),
